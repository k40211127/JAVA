...
public class Call_Co2 {
	...
	public Call_Co2() throws IOException, Exception {
		...
		//原序
		System.out.print("Process原序：");for (int i=0;i<Process.length;i++){System.out.print(" "+i+" ");}System.out.println();
...
//		new Co2(Process,Power,startTime);
		...
		for (int i=0;i<size;i++){num1[i]=i;}	//賦予第一個陣列[0~9]陣列0~9的數值
		...
		//新序對應功健
		System.out.print("Process功健：");for (int i=0;i<order.length;i++){System.out.print((int)Process[i]+" ");}System.out.println();
